...
def get_arg_parser(title):
    ...
    parser.add_argument('--max_reduce_steps', type=int, default=200)
    ...
    if title == 'vrptw':
        data_group.add_argument('--train_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_test.json')
        data_group.add_argument('--val_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_val.json')
        data_group.add_argument('--test_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_test.json')
        data_group.add_argument('--lr', type=float, default=1e-3)
        ...
        data_group.add_argument('--embedding_size', type=int, default=10)
        data_group.add_argument('--attention_size', type=int, default=16)
        data_group.add_argument('--lambda_', type=int, default=0.1)
    elif title == 'vrp':
        data_group.add_argument('--train_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_train.json')
        data_group.add_argument('--val_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_val.json')
        data_group.add_argument('--test_dataset', type=str, default='/home/yangzhekong/Documents/nw/data/vrptw/vrptw_20_30_test.json')
        data_group.add_argument('--lr', type=float, default=1e-3)
        data_group.add_argument('--value_loss_coef', type=float, default=0.01)
