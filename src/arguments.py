...
def get_arg_parser(title):
    ...
    if title == 'vrptw':
        data_group.add_argument('--train_dataset', type=str, default='../data/vrptw/vrptw_20_30_train.json')
        data_group.add_argument('--val_dataset', type=str, default='../data/vrptw/vrptw_20_30_val.json')
        data_group.add_argument('--test_dataset', type=str, default='../data/vrptw/vrptw_20_30_test.json')
        data_group.add_argument('--lr', type=float, default=5e-3)
        ...
        data_group.add_argument('--lambda_', type=int, default=1.0)
    elif title == 'vrp':
        data_group.add_argument('--train_dataset', type=str, default='../data/vrptw/vrptw_20_30_train.json')
        data_group.add_argument('--val_dataset', type=str, default='../data/vrptw/vrptw_20_30_val.json')
        data_group.add_argument('--test_dataset', type=str, default='../data/vrptw/vrptw_20_30_test.json')
