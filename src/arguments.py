...
def get_arg_parser(title):
    ...
    if title == 'vrptw':
        data_group.add_argument('--train_dataset', type=str, default='../data/vrp/vrptw_20_30_train.json')
        data_group.add_argument('--val_dataset', type=str, default='../data/vrp/vrptw_20_30_val.json')
        data_group.add_argument('--test_dataset', type=str, default='../data/vrp/vrptw_20_30_test.json')
